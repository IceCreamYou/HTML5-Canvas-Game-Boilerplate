/**
 * HTML5 Canvas Game Boilerplate 2.1.1-07082018
...
App.beforeSetup = function () {
    ...
    if (typeof Stats !== 'undefined' && App.debugMode) {
        ...
        App.stats.dom.style.left = $canvas.offset().left;
        App.stats.dom.style.top = $canvas.offset().top;
...
App.preventDefaultKeyEvents = function (combinations) {
    if (jQuery.hotkeys) {
        jQuery(document).keydown(combinations, function () {
            return false;
        });
    }
...
Mouse.Scroll = (function () {
    ...
    var easings = {
        ...
        SMOOTH: function (val) {
            return 0.5 - Math.cos((1 - val) * Math.PI) / 2;
        },
        EXPONENTIAL: function (val) {
